angular.module('Gamifyi', ['ui.router','ngSanitize','app.events','app.corporates.quests'])
    ...
    .controller('HomeCtrl', ['$scope', '$state','$stateParams', function($scope, $state,$stateParams) {
        ...
        var onload = function(){
            ...
            document.title='gamiFYI - Discover places around you by playing treasure hunts, quests, walks, tours - all from your mobile device';
    ...
    .config(function($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $stateProvider
            ...
            .state('app.contact', {
                ...
                controller:function($scope){
                    document.title='Contact - gamiFYI';
                    $scope.setCityChangeEventListener(null);
                    window.scrollTo(0, 0);
                }
            })
            ...
            .state('app.contest', {
                ...
                controller:function($scope){
                    document.title='Contest and Offers - gamiFYI';
                    $scope.setCityChangeEventListener(null);
                    window.scrollTo(0, 0);
                }
            })
           ...
           .state('app.asSeen', {
                ...
                controller:function($scope){
                    document.title='As Seen On - gamiFYI';
                    $scope.setCityChangeEventListener(null);
                    window.scrollTo(0, 0);
                }
            })
